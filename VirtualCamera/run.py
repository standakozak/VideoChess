...
from basics import calculate_statistics, calculate_mode, calculate_entropy, equalize_histogram, plot_histogram
from basics import apply_gabor_filter, apply_sobel_filter, apply_sobel_own_implentation, apply_linear_transformation
from basics import apply_gabor_own_implementation, GABOR_VALUES_1, GABOR_VALUES_2, GABOR_VALUES_3
import cv2
...
def custom_processing(img_source_generator):
    ...
    hand_landmarker = OwnHandLandmarker(model_path="./VirtualCamera/models/hand_landmarker.task")
    gesture_recognizer = GestureRecognizer(model_path="./VirtualCamera/models/gesture_recognizer.task", uses_rgb=True, flip_image=True)
